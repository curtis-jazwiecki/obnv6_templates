...
<td valign="center" align="center"><div class="camera_wrap camera_azure_skin" id="camera_wrap_1">
 <div data-src="includes/sts_templates/full/template2/camera/images/slides/slide1.png"> </div>
<div  data-src="includes/sts_templates/full/template2/camera/images/slides/slide2.png"> </div>
 <div data-src="includes/sts_templates/full/template2/camera/images/slides/slide3.png"> </div>
</div></td></tr></table></div>
<!--End of slider-->
  <div style="width:100%; background-color:#000; height:5px;"></div>
...
<?php } ?> 
   ...
   <?php if($_SERVER['PHP_SELF'] == "/index.php") { ?> <div style="width:100%; margin-left:16%; padding-top:50px; padding-bottom:50px; " class="fullbanner"><table  width="68%"  border="0" cellpadding="0" cellspacing="15" >
	<tr>
