			  ...
			  <!--right_td_start-->
				<td valign="top" align="center" width="40%" >
					...
					<tr>
					  <td valign="top">
						<table width="100%" cellpadding="0" cellspacing="0">
                          ...
                          <tr>
                            <td class="main" valign="top">
                              <b><span style="font-size: 14px"><h2>DISPLAY_PRODUCT_MANUFACTURER</h2></span></b>
                            </td>
                          </tr>
                          <tr height="8px;">
                            <td><span style="font-size: 14px"><h2>Item#: <span class="smallText model" id="productItem12">$productmodel</span></h2></span></td>
                          </tr>
                          ...
                          <tr>
                            <td class="productPrice"><b>$product_availability_n_price</b></td>
                          </tr>
                        </table>
                	  </td>
                    </tr>
                  ...
                  <table>
                    <tr>
                      <td><strong>Shipping to lower 48 states only.<br>All orders require phone verification.<br>Prices for internet orders only. <br>Not all products available in store.</strong></td>
                    </tr>
                    <tr>
                      <td>
                       <table width="100%" align="center">
                         <tr>
                          <td class="main" align="center"><b>Overall Customer Rating:</b></td>
                           ...
                           <tr>
                            <td class="main rating_text_color">DISPLAY_PRODUCT_WRITE_RATINGS</td>
                          </tr>
                        </table>
                      </td>
                    </tr>
